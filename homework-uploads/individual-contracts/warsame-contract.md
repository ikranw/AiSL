My senior design project is about creating an additional resource for people learning
American Sign Language (ASL). Most of the reputable resources readily available on the
Internet are websites of teachers or interpreters signing a word at a time in a short video with a
search bar to navigate. This senior design project, named AiSL, will provide an interactive 3D
model with an input box for users. The input box will take in an English sentence or word. Then,
...
Development course taught us how to develop a database and understand database relations.
This will help us in developing a database of signs for the avatar to sign in the project. In the
Python Programming course, we learned how to program in python. We learned fundamentals
...
knowledge and develop a deeper understanding of signing ASL. It will also be a free resource.
Our approach in designing a solution was understanding who the tool will be for, how the
tool will be designed, what functions it needs, and how accessible it will be. Our expected result
will have a working avatar that will be capable of signing signs in the right ASL grammar. As for
the length and amount of vocabulary it will be capable of signing, with the timeline we have, we
are leaning towards having it sign a set amount of sentences and words that will be verified by
